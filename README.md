...
- **Retornar** ràpidament un dispositiu
...
> Això esborra totes les dades. La propera vegada que arrenquis es tornarà a crear la BD amb les dades de prova.
...
| Usuari | Rol | Accés |
|---|---|---|
| `admin` | Admin | Panell de gestió complet |
| `professor` | Professor | Panell de gestió complet |
| `editor` | Editor | Panell de gestió (sense crear ni eliminar) |
